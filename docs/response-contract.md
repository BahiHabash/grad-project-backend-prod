# 📄 Unified API Response Contract Specification
...
## 1\. ⚙️ Core Response Metadata (`IResponse`)
...
| `path`       | `string`  | The requested URL path (excluding query parameters).                                                            | `"/users"`                   |

---

## 2\. ✅ Success Response Structure (`ISuccessResponse<T>`)
...
## 3\. ❌ Error Response Structure (`IErrorResponse`)
